      ...
      <section className={styles.kpiDashboardPage}>
        <div className={styles.narrowContent}>
          <header className={styles.hero}>
            <h1>KPI Dashboard for Retail Banking</h1>
            <p className={styles.subtitle}>
              Executive overview of performance across all key metrics
            </p>
          </header>
          ...
          <div className={styles.projectOverview}>
            <p>
              For this project, I took a sample banking dataset from Kaggle and built a KPI dashboard using Tableau. The aim was to give bank executives a clear, immediate view of the bank's most important metrics. By bringing all the key data together, this dashboard makes it easy for decision-makers to understand the current state of the business without having to sort through spreadsheets or lengthy reports.
            </p>
          </div>
          ...
          <section className={styles.dashboardExplanation}>
            <h2 className={styles.sectionHeading}>Dashboard Components</h2>
            <ul>
              <li>
          ...
          <section className={styles.recommendation}>
            <h2 className={styles.sectionHeading}>My Recommendation</h2>
            <p>
              Looking at the dashboard, my first priority would be to address the high churn rate and the large number of inactive customers.
