  ...
  return (
    <section className={styles.salesForecastingPage}>
      ...
      <section className={styles.actualSalesSection}>
        ...
        <div className={styles.actualSalesList}>
          <div className={styles.actualSalesBlock}>
            ...
            <div className={styles.caption}>Actual Sales – Excel Model</div>
          </div>
          <div className={styles.actualSalesBlock}>
            <img src="/sales-forecasting/sarima_actual_sales.png" alt="SARIMA Actual Sales" />
            <div className={styles.caption}>Actual Sales – SARIMA Model</div>
          </div>
          <div className={styles.actualSalesBlock}>
            <img src="/sales-forecasting/prophet_actual_sales.png" alt="Prophet Actual Sales" />
            <div className={styles.caption}>Actual Sales – Prophet Model</div>
          </div>
        </div>
      </section>
      ...
      <section className={styles.visuals}>
        <h2>Sales Forecast Visuals (Next 20 Weeks)</h2>
        <div className={styles.visualList}>
          <div className={styles.visualBlock}>
            <img src="/images/excel_forecast.png" alt="Excel Forecast" />
            <div className={styles.caption}>
              <strong>Excel Forecast:</strong> Simple trend extension, but limited for seasonality.
            </div>
          </div>
          <div className={styles.visualBlock}>
            <img src="/images/sarima_forecast.png" alt="SARIMA Forecast" />
            <div className={styles.caption}>
              <strong>SARIMA:</strong> Captures cyclical patterns and uncertainty.
            </div>
          </div>
          <div className={styles.visualBlock}>
            <img src="/images/prophet_forecast.png" alt="Prophet Forecast" />
            <div className={styles.caption}>
      ...
      <section className={styles.tablesSection}>
        ...
        <div className={styles.tablesList}>
          <div className={styles.tableBlock}>
            <img src="/images/excel_forecast_table.png" alt="Excel Forecast Values" />
            <div className={styles.caption}>Excel Forecasted Values</div>
          </div>
          <div className={styles.tableBlock}>
            <img src="/images/sarima_forecast_table.png" alt="SARIMA Forecast Values" />
            <div className={styles.caption}>SARIMA Forecasted Values</div>
          </div>
          <div className={styles.tableBlock}>
            <img src="/images/prophet_forecast_table.png" alt="Prophet Forecast Values" />
            <div className={styles.caption}>Prophet Forecasted Values</div>
          </div>
        </div>
      </section>
      ...
      <section className={styles.metricsSection}>
        <h2>Results: Model Performance</h2>
      ...
      <section className={styles.analysisSection}>
        ...
        <p>
          Comparing all three models provides a practical view of how forecasting works in real business scenarios. Excel forecasting offers the quickest way to estimate future sales, making it ideal for rapid, high-level checks and boardroom discussions where transparency is key. However, its simplicity means it struggles with more complex sales patterns, like holidays or sudden shifts.
          <br /><br />
